        ...
        <div class="col-lg-9">
          <form wire:submit="updateProfil">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  <label class="form-label mb-2">Username / Email <span class="text-danger">*</span></label>
              ...
              @can('umkm')
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    <label class="form-label mb-2">Link Maps <span class="text-dark">*</span></label>
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  <label class="form-label mb-2">Password Baru <span class="text-danger">*</span></label>
                  <input placeholder="******" wire:model="new_password" type="text" class="form-control">
                  @error('new_password')
                    <div class="form-text text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  <label class="form-label mb-2">Konfirmasi Password <span class="text-danger">*</span></label>
