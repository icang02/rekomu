<div>
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            ...
            <h6 class="op-7 mb-2">Sistem Rekomendasi Produk UMKM</h6>
        </div>
        <div class="ms-md-auto py-2 py-md-0">
            <a href="{{ route('front.beranda') }}" class="btn btn-primary btn-round">Halaman Depan</a>
        </div>
    </div>
    <div class="row">
        @can('admin')
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">{{ $countUmkm }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">{{ $countItem }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">{{ $countUlasan }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        var statisticsChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    //     fill: true,
                    //     borderWidth: 2,
                    //     data: [10, 23, 4, 55, 22, 3, 70, 121, 5, 10]
                    // }, {
                    //     label: "New Visitors",
                    //     borderColor: '#fdaf4b',
                    ...
                    // }, 
                    {
                        ...
                        fill: true,
                        borderWidth: 2,
                        data: {!! json_encode($totalQuantities->pluck('total_qty')) !!}
                    }
                ]
            },
            options: {
