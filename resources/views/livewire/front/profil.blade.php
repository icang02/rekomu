    ...
    <div class="latest-news mb-100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5" style="margin: 4.5rem 0;">
                ...
                <div class="col-lg-7" style="margin: 4.5rem 0;">
                    <div class="card shadow">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <p wire:loading wire:target="image" style="font-size: 0.87rem; font-weight: 600;"
                                class="text-loading">
                                Uploading...</p>
                            @error('image')
                        ...
                        <div class="card-body">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <button wire:click="resetForm" type="button" class="close"
                                        ...
                                        <form wire:submit="resetPassword">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button wire:click="resetForm" type="button"
                                                    class="btn btn-light border" data-dismiss="modal">Batal</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form wire:submit="confirmDeleteAccount">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label style="cursor: text">ketik "{{ auth()->user()->email }}"
                                                        untuk konfirmasi hapus
                                                        akun.</label>
                                                    <input wire:model.live="check_email" type="text"
                                                        class="form-control">
                                                    @error('check_email')
                                                        <small class="form-text text-danger">
                                                            {{ $message }}</small>
                            ...
                            <div wire:ignore.self class="modal fade" id="exampleModal2" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form wire:submit="deleteAccount">
                                            <div class="modal-body">
                                                Setelah akun terhapus seluruh data tidak dapat dipulihkan. Lanjutkan
                                                hapus akun?
                                            </div>
                                            <div class="modal-footer">
                            ...
                            <form wire:submit="update">
                                <div class="row">
                                    <div class="col-lg-12 text-center mt-2">
                                        ...
                                        <input class="d-none" type="file" wire:model="image" id="image"
                                            accept="image/*">
                                    </div>
                                    <div class="col-lg-12 mt-4">
                                        <div class="mb-4">
                                            <h6 class="text-c-dark text-ms">Email</h6>
                                            <p class="text-c-muted text-sm">Alamat email yang digunakan untuk login ke
                                                dalam akun.</p>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="text-c-muted text-sm">Nama yang digunakan untuk ditampilkan di
                                                sistem.</p>
                                        ...
                                        <div class="mb-4">
                                            <h6 class="text-c-dark text-ms">Kontak</h6>
                                            <p class="text-c-muted text-sm">
                                                Nomor telpon aktif yang dapat dihubungi.
                                            </p>
                                            <div class="d-flex">
                                                <label
                                                    class="form-control py-4 d-flex align-items-center justify-content-center"
                                                    style="margin-top: -10px; font-size: 1rem; max-width: 50px;">
                                                    +62
                                                </label>
                                                <input wire:model="contact" type="text" inputmode="numeric"
                                        ...
                                        <div class="mb-4">
                                            <h6 class="text-c-dark text-ms">Alamat</h6>
                                            <p class="text-c-muted text-sm">Alamat lengkap pengiriman.</p>
                                            <textarea wire:model="address" type="text" class="form-control py-2" style="margin-top: -10px; font-size: 1rem;"
                                                rows="3"></textarea>
                                            @error('address')
                                                <span class="text-danger"
                                                    style="font-size: 0.85rem;">{{ $message }}</span>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            @if (session('success'))
                                                <span
                                                    style="font-size: 0.87rem; font-weight: 600; transition: 0.3s ease-in;"
