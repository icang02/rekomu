        ...
        <div class="container">
            @if (!$transactions->isEmpty())
                <div class="row justify-content-center">
                        ...
                        <div class="cart-table-wrap custom">
                            <table class="cart-table">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <span
                                                                            class="mr-5">{{ $transaction->seller->user->name }}</span>
                                                                        <div class="d-flex align-items-center">
                                                                            <svg style="margin-right: 1px;"
                                        ...
                                        <tr class="table-body-row">
                                            ...
                                            <td>
                                                <img class="rounded"
                                                    ...
                                                    src="{{ asset('storage/' . $transaction->item->image) }}"
                                                    alt="produk">
                                            </td>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            @if ($i <= $transaction->rating)
                                                                <svg style="margin-right: 1px;" height="12px"
                                                                    width="12px" version="1.1" id="Capa_1"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                C22.602,0.567,25.338,0.567,26.285,2.486z" />
                                                ...
                                                @else
                                                    <span style="font-size: 0.85rem;" class="text-muted">Belum
                                                        rate</span>
                                                @endif
                                            </td>
                                            <td class="product-quantity">
                                                <button data-toggle="modal"
                                                    data-target="#staticBackdrop{{ $transaction->id }}"
                                                    class="btn btn-info badge">Detail</button>
                                                <button wire:click="setRatingInput({{ $transaction->id }})"
                                                    {{-- wire:click="setRatingInput({{ $transaction->id }}, '{{ $transaction->item->name }}', '{{ $transaction->rating }}', '{{ $transaction->review }}')" --}}
                    ...
                    <div class="col-lg-3">
                        <div class="total-section" style="position: sticky; top: 110px;">
                                        ...
                                        <tr class="total-data">
                                            <td>
                                                <div class="mb-3">
                                                    ...
                                                    <input min="1" max="5" @readonly(!$itemName)
                                                        wire:model="ratingInput" value="{{ $ratingInput }}"
                                                        type="number" class="form-control mt-1 w-100"
