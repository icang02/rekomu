      ...
      <div class="row">
        <div class="col-lg-12" style="margin: 4.5rem 0;">
          ...
          <div class="input-group mx-auto" style="max-width: 500px;">
            <input wire:model.live="search" type="text" class="form-control py-4" placeholder="Cari produk...">
                  ...
                  <div class="news-text-box">
                    ...
                    <div class="d-flex align-items-center mt-1">
                      <div class="d-flex align-items-center">
                        ...
                        @for ($i = 1; $i <= 5; $i++)
                          @if ($i <= $average_rating)
                            <svg style="margin-right: 1px;" height="12px" width="12px" version="1.1" id="Capa_1"
          ...
          <div class="card">
            ...
            <ul class="list-group list-group-flush">
              ...
              @foreach ($categories as $category)
                <li class="list-group-item" style="color: {{ $this->category == $category->id ? '#F28123' : '' }};"
                  wire:click="$set('category', {{ $category->id }})">
                  {{ $category->name }}
                </li>
                {{-- <li class="list-group-item" style="color: {{ request('category') == $category->id ? '#F28123' : '' }};"
                  onclick="Livewire.navigate('{{ route('front.produk', ['category' => $category->id]) }}')">
                  {{ $category->name }}
                </li> --}}
              @endforeach
            </ul>
